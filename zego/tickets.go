...
func (a Auth) ListTickets(page string) (*Resource, error) {

	path := "/tickets.json?page=" + page
...
func (a Auth) UpdateTicket(ticket_id string, params string) (*Resource, error) {

	path := "/tickets/" + ticket_id + ".json"
	resource, err := api(a, "PUT", path, params)
	if err != nil {
		return nil, err
	}
